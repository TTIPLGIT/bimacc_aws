    ...
    <div class="col-md-12">
      ...
      <div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="rclaimforcontractpriceinerestwithoutinterest"  name="claimforcontractpriceinerestwithoutinterest" style="width:9%" value="yes">
