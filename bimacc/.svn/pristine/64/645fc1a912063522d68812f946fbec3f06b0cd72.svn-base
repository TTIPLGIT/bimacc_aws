...
<div class="modal fade" id="amendclaimantmodal{{$notice->id}}" tabindex="-1" role="dialog" aria-labelledby="amendclaimantmodal" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
         <form  action="{{ route('claimnotice.amendupdate') }}" method="POST" enctype="multipart/form-data">
        @csrf 
