<form  name="reliefrequest_form" id="reliefrequest_form" method="POST" >
  ...
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="rclaim_subs_contrib_amount_interest" class="form-control{{ $errors->has('claim_subs_contrib_amount_interest') ? ' is-invalid' : '' }}" name="claim_subs_contrib_amount_interest"  >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="rclaim_subs_contrib_amount_withoutinterest" class="form-control" style="width:7%" name="claim_subs_contrib_amount_withoutinterest" value="yes" >
...
<div class="row">
  ...
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="rclaim_refund_deposit_amount_interest" class="form-control{{ $errors->has('claim_refund_deposit_amount_interest') ? ' is-invalid' : '' }}" name="claim_refund_deposit_amount_interest"  >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="rclaim_refund_deposit_amount_withoutinterest" class="form-control" style="width:7%" name="claim_refund_deposit_amount_withoutinterest" value="yes" >
...
$('#rclaim_subs_contrib_amount_withoutinterest').on('click', function () {
  if ($(this).prop('checked')) {
                document.getElementById("rclaim_subs_contrib_amount_interest").disabled = true;
                //$('#demand_for_licence_fee_interest').disabled();
                $('#rclaim_subs_contrib_amount_interest').val("");

            } else {
               document.getElementById("rclaim_subs_contrib_amount_interest").disabled = false;
                $('#rclaim_subs_contrib_amount_interest').val("");
            }
});
$('#rclaim_refund_deposit_amount_withoutinterest').on('click', function () {
  if ($(this).prop('checked')) {
                document.getElementById("rclaim_refund_deposit_amount_interest").disabled = true;
                //$('#demand_for_licence_fee_interest').disabled();
                $('#rclaim_refund_deposit_amount_interest').val("");

            } else {
               document.getElementById("rclaim_refund_deposit_amount_interest").disabled = false;
                $('#rclaim_refund_deposit_amount_interest').val("");
            }
});
