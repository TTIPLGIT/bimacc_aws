...
class AesForJavaController extends Controller {
    ...
    public function setMode($mode) {
        switch ($mode) {
            case AesForJavaController::M_CBC:
                $this->mode = "MCRYPT_MODE_CBC";
                break;
            case AesForJavaController::M_CFB:
                $this->mode = "MCRYPT_MODE_CFB";
                break;
            case AesForJavaController::M_ECB:
                $this->mode = "MCRYPT_MODE_ECB";
                break;
            case AesForJavaController::M_NOFB:
                $this->mode = "MCRYPT_MODE_NOFB";
                break;
            case AesForJavaController::M_OFB:
                $this->mode = "MCRYPT_MODE_OFB";
                break;
            case AesForJavaController::M_STREAM:
