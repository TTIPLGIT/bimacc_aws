...
<div class="row">
 ...
 @if($bank_accounts->claim_id == $details->claimdetailsid)
   ...
   <div class="col-md-1"><input class="form-control" placeholder='Loan{{ $loop->iteration}}'  type="text" disabled ></div>
          <div class="col-md-2"> 
        ...
        <div class="col-md-3"> 
         <div class="form-group">
           <input type="text" id="date_of_sanction" class="form-control{{ $errors->has('date_of_sanction') ? ' is-invalid' : '' }}"  value="{{$bank_accounts->date_of_sanction_bank}}" readonly>
...
@endforeach
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="npa_date_bank" class="form-control{{ $errors->has('npa_date_bank') ? ' is-invalid' : '' }}" name="npa_date_bank[]" value="{{$bank_accounts->npa_date_bank}}" readonly>
    ...
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="interest_bank" class="form-control{{ $errors->has('interest_bank') ? ' is-invalid' : '' }}" name="interest_bank[]" value="{{$bank_accounts->interest_bank}}" readonly>
    ...
    <div class="col-md-3">
      <div class="form-group">
        <input type="text" id="penel_interest_bank" class="form-control{{ $errors->has('penel_interest_bank') ? ' is-invalid' : '' }}"  value="{{$bank_accounts->penel_interest_bank}}" readonly>
    ...
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="amount_as_date" class="form-control{{ $errors->has('amount_as_date') ? ' is-invalid' : '' }}" name="amount_as_date" value="{{$bank_accounts->amount_as_date}}" readonly>
...
@endif
  @endforeach
    ...
    <div class="col-md-4"> 
      <div class="form-group">
        <input type="number" class="form-control{{ $errors->has('total_amount_bank') ? ' is-invalid' : '' }}" value="{{$details->total_amount_bank}}">
