...
<form  name="reliefrequest_form" id="reliefrequest_form" method="POST" >
  ...
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"   id="reid_claim_for_contract_price_interest" class="form-control{{ $errors->has('eid_claim_for_contract_price_interest') ? ' is-invalid' : '' }}" name="eid_claim_for_contract_price_interest"  >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="reid_claim_for_contract_price_withoutinterest" class="form-control" style="width:7%" name="eid_claim_for_contract_price_withoutinterest"  value="yes" onclick="document.getElementById('eid_claim_for_contract_price_interest').disabled=this.checked;" >
  ...
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"   id="reid_claim_for_refund_interest" class="form-control{{ $errors->has('eid_claim_for_refund_interest') ? ' is-invalid' : '' }}" name="eid_claim_for_refund_interest" >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="reid_claim_for_refund_withoutinterest" class="form-control" style="width:7%" name="eid_claim_for_refund_withoutinterest" value="yes" onclick="document.getElementById('eid_claim_for_refund_interest').disabled=this.checked;" >
...
<div class="row">
  ...
  <div class="col-md-4">  
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"   id="rclaim_for_escalation_of_costs_interest" class="form-control{{ $errors->has('claim_for_escalation_of_costs_interest') ? ' is-invalid' : '' }}" name="claim_for_escalation_of_costs_interest" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control" id="rclaim_for_escalation_of_costs_withoutinterest"  name="claim_for_escalation_of_costs_withoutinterest" style="width:7%" value="yes">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control" id="rclaim_for_damages_withoutinterest"  name="claim_for_damages_withoutinterest" style="width:7%" value="yes">
  </div>
...
$('#reid_claim_for_contract_price_withoutinterest').on('click', function () {
  if ($(this).prop('checked')) {
                document.getElementById("reid_claim_for_contract_price_interest").disabled = true;
                //$('#demand_for_licence_fee_interest').disabled();
                $('#reid_claim_for_contract_price_interest').val("");

            } else {
               document.getElementById("reid_claim_for_contract_price_interest").disabled = false;
                $('#reid_claim_for_contract_price_interest').val("");
            }
});
$('#reid_claim_for_refund_withoutinterest').on('click', function () {
  if ($(this).prop('checked')) {
                document.getElementById("reid_claim_for_refund_interest").disabled = true;
                //$('#demand_for_licence_fee_interest').disabled();
                $('#reid_claim_for_refund_interest').val("");

            } else {
               document.getElementById("reid_claim_for_refund_interest").disabled = false;
                $('#reid_claim_for_refund_interest').val("");
            }
});
$('#rclaim_for_escalation_of_costs_withoutinterest').on('click', function () {
  if ($(this).prop('checked')) {
                document.getElementById("rclaim_for_escalation_of_costs_interest").disabled = true;
                //$('#demand_for_licence_fee_interest').disabled();
                $('#rclaim_for_escalation_of_costs_interest').val("");
...
//             }
// });
$('#rclaim_for_damages_withoutinterest').on('click', function () {
  if ($(this).prop('checked')) {
