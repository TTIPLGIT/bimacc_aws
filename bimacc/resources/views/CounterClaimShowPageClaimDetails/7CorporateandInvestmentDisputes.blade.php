      ...
      <div class="row">
        <div class="col-md-3"> 
          <div class="form-group">
            <input type="date" id="sdate_of_agreement" class="form-control{{ $errors->has('date_of_agreement') ? ' is-invalid' : '' }}" name="date_of_agreement" placeholder=" " value="{{$details->date_of_agreement}}">
        ...
        <div class="col-md-3"> 
         <div class="form-group">
           <input type="date" id="sdate_of_breach" class="form-control{{ $errors->has('date_of_breach') ? ' is-invalid' : '' }}" name="date_of_breach" placeholder=" " value="{{$details->date_of_breach}}">
      ...
      <div class="col-md-3"> 
       <div class="form-group">
         <input type="date" id="sdate_of_notice" class="form-control{{ $errors->has('date_of_notice') ? ' is-invalid' : '' }}" name="date_of_notice" placeholder=" " value="{{$details->date_of_notice}}">
    ...
    <div class="col-md-3"> 
      <div class="form-group">
       <input type="text" id="sreason_for_claim" class="form-control{{ $errors->has('reason_for_claim') ? ' is-invalid' : '' }}" name="reason_for_claim" value="{{$details->reason_for_claim}}">
