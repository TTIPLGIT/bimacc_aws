...
This is with Reference to Electronic Arbitration System (EAS) - Claim Petition (No:{{$data1['arbitration_petionno']}})
 <br/><br/>
  ...
  <br/><br/>
Use the above link to view/access or download the Written Argumentsuploaded by the  Respondent with the permission of the learned Arbitrator during Hearing Number 1  <br/><br/>
