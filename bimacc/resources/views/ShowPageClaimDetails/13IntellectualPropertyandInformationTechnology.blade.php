       ...
       <div class="col-md-4">  
        <div class="form-group">
          ...
          <input type="date" id="date_of_registration" name="date_of_registration"  class="datechk form-control{{ $errors->has('date_of_registration') ? ' is-invalid' : '' }}"  value="{{$details->date_of_registration}}">
       ...
       <div class="col-md-4">  
        <div class="form-group">
          <input type="date" id="date_of_agreement" name="date_of_agreement"  class="datechk form-control{{ $errors->has('date_of_agreement') ? ' is-invalid' : '' }}"  value="{{$details->date_of_agreement}}">
...
<label class="form-control-placeholder" for="date_of_agreement">Date of Agreement/ Assignment:</label>
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <input type="date" id="date_of_licence" class="datechk form-control{{ $errors->has('date_of_licence') ? ' is-invalid' : '' }}" name="date_of_licence"  value="{{$details->date_of_licence}}">
  ...
  <div class="row">
    <div class="col-md-4">  
        <div class="form-group">
          <input type="date" id="date_of_breach_or_infringement" name="date_of_breach_or_infringement"  class="datechk form-control{{ $errors->has('date_of_breach_or_infringement') ? ' is-invalid' : '' }}"  value="{{$details->date_of_breach_or_infringement}}">
     ...
     <div class="col-md-4"> 
        <div class="form-group">
         <input type="date" id="earliest_date_of_prior_use" class="datechk form-control{{ $errors->has('earliest_date_of_prior_use') ? ' is-invalid' : '' }}" name="earliest_date_of_prior_use"  value="{{$details->earliest_date_of_prior_use}}">
