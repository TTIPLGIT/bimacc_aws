    ...
    <div class="row">
      <div class="col-md-6">  
        <div class="form-group">
         <textarea id="injurydetails" class="form-control{{ $errors->has('injurydetails') ? ' is-invalid' : '' }}" name="injurydetails"></textarea>
    ...
    <div class="col-md-6"> 
      <div class="form-group">
       <input type="number" id="claimamount" class="form-control{{ $errors->has('claimamount') ? ' is-invalid' : '' }}" name="claimamount" >
...
<div class="row">
  <div class="col-md-6"> 
      <div class="form-group">
       <input type="textarea" id="reason_for_claim" value="{{ $claimDetail->reason_for_claim }}" class="form-control{{ $errors->has('reason_for_claim') ? ' is-invalid' : '' }}" name="reason_for_claim" >
