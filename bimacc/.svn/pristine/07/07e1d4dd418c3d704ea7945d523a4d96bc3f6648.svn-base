    <form  action="{{ route('claimdetails.store') }}" method="POST" style="    width: 100%;" >
      ...
      <div class="row register-form">
        ...
        <div class="row">
          <div class="col-md-4"> 
            <div class="form-group">
             <input type="text" id="csvesselname" class="form-control{{ $errors->has('vesselname') ? ' is-invalid' : '' }}" name="vesselname" >
        ...
        <div class="col-md-4"> 
          <div class="form-group">
            <input type="text" id="cscargonature" class="form-control{{ $errors->has('cargonature') ? ' is-invalid' : '' }}" name="cargonature" >
        ...
        <div class="col-md-4"> 
         <div class="form-group">
           <input type="text" id="csquantity" class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}" name="quantity" >
    ...
    <div class="row">
      <div class="col-md-6">  
        <div class="form-group">
         <textarea id="csinjurydetails" class="form-control{{ $errors->has('injurydetails') ? ' is-invalid' : '' }}" name="injurydetails"></textarea>
    ...
    <div class="col-md-6"> 
      <div class="form-group">
       <input type="text" id="csclaimamount" class="form-control{{ $errors->has('claimamount') ? ' is-invalid' : '' }}" name="claimamount" >
