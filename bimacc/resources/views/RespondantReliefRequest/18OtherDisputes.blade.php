  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="rclaim_for_payment_of_damages_interest" class="form-control" style="width:7%" name="claim_for_payment_of_damages_interest" value="yes" >
      ...
      <div class="row">
        ...
        <div class="col-md-4"> 
          <div class="form-group">
            <input type="text" onkeypress="return isNumberKey(event)"  id="rvalue_performance_int" class="form-control{{ $errors->has('value_performance_int') ? ' is-invalid' : '' }}" name="value_performance_int" >
