    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="claim_for_refund_of_fare_or_freight_withoutinterest"  name="claim_for_refund_of_fare_or_freight_withoutinterest" style="width:7%" value="yes">
       </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="claim_for_payment_of_freight_withoutinterest"  name="claim_for_payment_of_freight_withoutinterest" style="width:7%"  value="yes">
       </div>
     </div>
   </div>
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="claim_for_payment_of_damages_withoutinterest"  name="claim_for_payment_of_damages_withoutinterest" style="width:7%" value="yes" >
       </div>
     </div>
   </div>
     ...
     <div class="col-md-4"> 
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="demanding_policy_claim_amount_withoutinterest"  name="demanding_policy_claim_amount_withoutinterest" style="width:7%"  value="yes">
       </div>
     </div>
   </div>
<div class="row">
    ...
    <div class="col-md-4"> 
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="demanding_surrender_value_amount_withoutinterest"  name="demanding_surrender_value_amount_withoutinterest" style="width:7%"  value="yes">
       </div>
     </div>
   </div>
   <div class="row">
    ...
    <div class="col-md-3"> 
      ...
      <div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="subrogation_value_withoutinterest"  name="subrogation_value_withoutinterest" style="width:9%" value="yes">
       </div>
     </div>
  ...
  @csrf  
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="claim_for_refund_of_fare_or_freight_withoutinterest" style="margin-left: 18px">Without Interest</label>
         <input type="checkbox" class="form-control" id="claim_for_refund_of_fare_or_freight_withoutinterest"  name="claim_for_refund_of_fare_or_freight_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->claim_for_refund_of_fare_or_freight_withoutinterest == 'yes' ? 'checked' : ''}} >
       </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="claim_for_payment_of_freight_withoutinterest" style="margin-left: 18px">Without Interest</label>
         <input type="checkbox" class="form-control" id="claim_for_payment_of_freight_withoutinterest"  name="claim_for_payment_of_freight_withoutinterest" style="width:7%"  value="yes" {{ $ReliefRequest->claim_for_payment_of_freight_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
   </div>
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="claim_for_payment_of_damages_withoutinterest" style="margin-left: 18px">Without Interest</label>
         <input type="checkbox" class="form-control" id="claim_for_payment_of_damages_withoutinterest"  name="claim_for_payment_of_damages_withoutinterest" style="width:7%"  value="yes" {{ $ReliefRequest->claim_for_payment_of_damages_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
   </div>
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="claim_for_demurrages_withoutinterest" style="margin-left: 18px">Without Interest</label>
         <input type="checkbox" class="form-control" id="claim_for_demurrages_withoutinterest"  name="claim_for_demurrages_withoutinterest" style="width:7%" value="yes"  {{ $ReliefRequest->claim_for_demurrages_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
   </div>
      <div class="row">
     ...
     <div class="col-md-4"> 
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="demanding_policy_claim_amount_withoutinterest" style="margin-left: 18px">Without Interest</label>
         <input type="checkbox" class="form-control" id="demanding_policy_claim_amount_withoutinterest"  name="demanding_policy_claim_amount_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->demanding_policy_claim_amount_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
   </div>
<div class="row">
    ...
    <div class="col-md-4"> 
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="demanding_surrender_value_amount_withoutinterest" style="margin-left: 18px">Without Interest</label>
         <input type="checkbox" class="form-control" id="demanding_surrender_value_amount_withoutinterest"  name="demanding_surrender_value_amount_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->demanding_surrender_value_amount_withoutinterest == 'yes' ? 'checked' : ''}} >
       </div>
     </div>
   </div>
   <div class="row">
    <div class="col-md-3"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="challenging_cancellation_of_policy" style="margin-left: 18px">Challenging Cancellation of Policy Value:</label>
         <input type="checkbox" class="form-control" id="challenging_cancellation_of_policy"  name="challenging_cancellation_of_policy" style="width:9%" value="yes" {{ $ReliefRequest->challenging_cancellation_of_policy == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
    ...
    <div class="col-md-3"> 
      ...
      <div class="col-md-3"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="subrogation_value_withoutinterest" style="margin-left: 18px">Without Interest</label>
         <input type="checkbox" class="form-control" id="subrogation_value_withoutinterest"  name="subrogation_value_withoutinterest" style="width:9%" value="yes" {{ $ReliefRequest->subrogation_value_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
   </div>
    <div class="row">
