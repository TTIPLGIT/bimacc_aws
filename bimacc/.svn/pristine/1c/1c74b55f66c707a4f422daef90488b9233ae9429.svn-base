...
<div class="modal fade" id="amendrespondantmodal{{$notice->id}}" tabindex="-1" role="dialog" aria-labelledby="amendrespondantmodal" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
         @if ($respondantinformations[0]->claimant_respondant_type_Code =='IS' )
        <h5 class="modal-title" id="amendrespondantmodal">Amend Details
...
-{{$notice->claimnoticeno}}</h5>
      ...
      <div class="modal-body"> 
         <form  action="{{ route('claimantrespondantaccess.amendupdate') }}" method="POST" enctype="multipart/form-data">
        @csrf 
