          ...
          <div class="row" style="margin-bottom: 17px;">
            <div class="col-xl-6 col-sm-6 mb-6" >
                 ...
                 <!--  @role('centre')
                  ...
                  @endrole -->
                  @role('claiment')
                  <div class="card border-left-primary shadow " style="display: none;">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Number Of Ongoing Arbitration </div>
    ...
    <div class="col-auto">
      ...
      @endrole -->
      @role('claiment')
      <div class="card border-left-info shadow " style="display: none;">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
...
<div class="row" style="margin-bottom: 17px;">
  <div class="col-xl-6 col-sm-6 mb-6" >
        ...
        <!--  @role('arbitrator')
          <div class="card border-left-pri shadow ">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
   ...
   @endrole
    ...
    <div class="col-xl-6 col-sm-6 mb-6" >
         ...
         <!--  @role('centre')
          ...
          @endrole -->
          @role('claiment')
          <div class="card border-left-succ shadow " style="display: none;">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
          ...
          @endrole
          <!-- @role('arbitrator')
           <div class="card border-left-succ shadow ">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
  ...
  <!-- <div class="col-xl-5 col-sm-5">
    <div class="card border-left-warning shadow " style="
