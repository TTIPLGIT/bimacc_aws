   <div class="row register-form" style="pointer-events: none;">
    <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-4"> 
          <div class="form-group">
            <input type="text" id="claimforontractprice"   class="form-control{{ $errors->has('claimforontractprice') ? ' is-invalid' : '' }}" name="claimforontractprice" value="{{ number_format((float)$details->claimforontractprice, 2, '.', '') }}">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
          <input type="text" onkeypress="return isNumberKey(event)"  id="claimforcontractpriceinerest" class="form-control{{ $errors->has('claimforcontractpriceinerest') ? ' is-invalid' : '' }}" name="claimforcontractpriceinerest"  value="{{$details->claimforcontractpriceinerest}}" >
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="claimforcontractpriceinerestwithoutinterest"  name="claimforcontractpriceinerestwithoutinterest" style="width:7%" value="yes" {{ $details->claimforcontractpriceinerestwithoutinterest == 'yes' ? 'checked' : ''}} >
       </div>
     </div>
   ...
   <div class="row">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)"  id="claim_for_refund"  value="{{ number_format((float)$details->claim_for_refund, 2, '.', '') }}" class="form-control{{ $errors->has('claim_for_refund') ? ' is-invalid' : '' }}" name="claim_for_refund" >
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="refund_withoutinterest" value="yes" name="refund_withoutinterest" style="width:7%"  {{ $details->refund_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
   ...
   <div class="row">
       <div class="col-md-4"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)"  id="claim_for_escalation_of_costs"  value="{{ number_format((float)$details->claim_for_escalation_of_costs, 2, '.', '') }}" class="form-control{{ $errors->has('claim_for_escalation_of_costs') ? ' is-invalid' : '' }}" name="claim_for_escalation_of_costs" >
    ...
    <div class="col-md-4"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)"  id="claim_for_damages"  value="{{ number_format((float)$details->claim_for_damages, 2, '.', '') }}" class="form-control{{ $errors->has('claim_for_damages') ? ' is-invalid' : '' }}" name="claim_for_damages" >
      ...
      <div class="col-md-3"> 
       ...
       <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)" id="to_terminate_contract"  class="form-control{{ $errors->has('to_terminate_contract') ? ' is-invalid' : '' }}" name="to_terminate_contract" value="{{ number_format((float)$details->to_terminate_contract, 2, '.', '') }}">
    ...
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)" id="to_vacate_contractual_site"  class="form-control{{ $errors->has('to_vacate_contractual_site') ? ' is-invalid' : '' }}" name="to_vacate_contractual_site"  value="{{ number_format((float)$details->to_vacate_contractual_site, 2, '.', '') }}">
   ...
   <!-- <div class="row">
        <div class="col-md-6"> 
      <div class="form-group">
        <input type="text" id="to_claim_for_specific_performance_to_purchase_power"  value="{{$details->to_claim_for_specific_performance_to_purchase_power}}" class="form-control{{ $errors->has('to_claim_for_specific_performance_to_purchase_power') ? ' is-invalid' : '' }}" name="to_claim_for_specific_performance_to_purchase_power" >
   ...
   <div class="row">
    ...
    <div class="form-group">
     ...
     <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)" id="specific_performance_of_contract"  class="form-control{{ $errors->has('specific_performance_of_contract') ? ' is-invalid' : '' }}" name="specific_performance_of_contract" value="{{ number_format((float)$details->specific_performance_of_contract, 2, '.', '') }}">
    ...
    <div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="to_return_materials"  name="to_return_materials" style="width:9%"   value="yes" {{ $details->to_return_materials == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
        <div class="col-md-3"> 
          
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)" id="estimated_value_of_material"  value="{{ number_format((float)$details->estimated_value_of_material, 2, '.', '') }}" class="form-control{{ $errors->has('estimated_value_of_material') ? ' is-invalid' : '' }}" name="estimated_value_of_material" >
      ...
      <div class="row">
        ...
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="to_cancel_performance_guarantees"  name="to_cancel_performance_guarantees" style="width:9%" value="yes" {{ $details->to_cancel_performance_guarantees == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
    <div class="col-md-3"> 
      ...
      <div class="form-group">
        <input type="text" id="amount_guaranteed"  value="{{ number_format((float)$details->amount_guaranteed, 2, '.', '') }}" class="form-control{{ $errors->has('amount_guaranteed') ? ' is-invalid' : '' }}" name="amount_guaranteed" >
