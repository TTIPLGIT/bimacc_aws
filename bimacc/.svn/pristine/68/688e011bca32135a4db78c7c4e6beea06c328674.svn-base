...
<div class="col-md-4"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)"  id="claim_for_contract_price_interest" class="form-control{{ $errors->has('claim_for_contract_price_interest') ? ' is-invalid' : '' }}" name="claim_for_contract_price_interest" >
...
<form  name="reliefrequest_update_form" class="div_id" id="reliefrequest_update_form" method="POST" >
  @csrf  
  <input type="text" name="reliefrequestid" style="display: none;" value="{{$ReliefRequest->id}}">
  <div class="row register-form">
    <div class="col-md-12">
      <div class="row"> 
       <div class="col-md-12">
    ...
    <div class="row">
      <div class="col-md-6">  
        <div class="form-group">
         <input type="text" onkeypress="return isNumberKey(event)"id="escalation_of_costs" class="form-control{{ $errors->has('escalation_of_costs') ? ' is-invalid' : '' }}" name="escalation_of_costs"  value="{{ number_format((float)$ReliefRequest->escalation_of_costs, 2, '.', '') }}">
         <label class="form-control-placeholder" for="escalation_of_costs">Escalation of Costs({{$claimantinformations[0]->currency}}):</label>
         @if ($errors->has('escalation_of_costs'))
         <span class="invalid-feedback" role="alert">
          <strong>{{ $errors->first('escalation_of_costs') }}</strong>
      ...
      <div class="col-md-6">  
      <div class="form-group">
       <input type="text" id="claim_for_damages" class="form-control{{ $errors->has('claim_for_damages') ? ' is-invalid' : '' }}" name="claim_for_damages" value="{{ number_format((float)$ReliefRequest->claim_for_damages, 2, '.', '') }}">
       <label class="form-control-placeholder" for="claim_for_damages">Damages:</label>
       @if ($errors->has('claim_for_damages'))
       <span class="invalid-feedback" role="alert">
        <strong>{{ $errors->first('claim_for_damages') }}</strong>
...
@if($contract_reliefs->relief_id == $ReliefRequest->id)
<div class="row">
<!-- <div class="col-md-4">  
</div> -->
...
@endforeach
 <div class="row">
<div class="col-md-1"><input class="form-control contract" value="{{$count_in}}"  type="text" disabled ><label class="form-control-placeholder">Sl. No.</label></div>  
<div class="col-md-5">  
  <div class="form-group" >
   <input type="text" onkeypress="return isNumberKey(event)"  id="contract_price" class="form-control{{ $errors->has('contract_price') ? ' is-invalid' : '' }}" name="contract_price[]" >
   <label class="form-control-placeholder" for="contract_price">Contract Price({{$claimantinformations[0]->currency}}):</label>
...
<div class="col-md-1">
<div class="buttons" id="commercial_btn2" >
  <span class="btn btn-icon btn-sm btn-success">
    <i class="far fa-plus-square"></i> </span>
  </div>
</div>
   <div class="col-md-1">
<div  id="commercial_del2" style="display:none;"  class="buttons"><span class="btn btn-icon btn-sm btn-danger remove"> <i class="fas fa-window-close"></i></span> </div>
</div>
</div>
...
<div class="row">
  <div class="col-md-6">
    <div class="form-group">
      <input type="text" id="specific_performance_of_contract" value="{{$ReliefRequest->specific_performance_of_contract}}" class="form-control{{ $errors->has('specific_performance_of_contract') ? ' is-invalid' : '' }}" name="specific_performance_of_contract" >
      <label class="form-control-placeholder" for="specific_performance_of_contract">Specific Performance of Contract:</label>
      @if ($errors->has('specific_performance_of_contract'))
      <span class="invalid-feedback" role="alert">
        <strong>{{ $errors->first('specific_performance_of_contract') }}</strong>
  ...
  <div class="col-md-6">
    <div class="form-group">
      <input type="text" onkeypress="return isNumberKey(event)"  id="specific_estimated_value_of_contract" class="form-control{{ $errors->has('specific_estimated_value_of_contract') ? ' is-invalid' : '' }}" name="specific_estimated_value_of_contract" value="{{ number_format((float)$ReliefRequest->specific_estimated_value_of_contract, 2, '.', '') }}" >
      <label class="form-control-placeholder" for="specific_estimated_value_of_contract">Estimated Value of Material({{$claimantinformations[0]->currency}}): </label>
      @if ($errors->has('specific_estimated_value_of_contract'))
      <span class="invalid-feedback" role="alert">
        <strong>{{ $errors->first('specific_estimated_value_of_contract') }}</strong>
...
<div class="row">
  <div class="col-md-6">
    <div class="form-group">
      <input type="text" onkeypress="return isNumberKey(event)"  id="tocancel_estimated_value_of_contract" class="form-control{{ $errors->has('tocancel_estimated_value_of_contract') ? ' is-invalid' : '' }}" name="tocancel_estimated_value_of_contract" value="{{ number_format((float)$ReliefRequest->tocancel_estimated_value_of_contract, 2, '.', '') }}">
      <label class="form-control-placeholder" for="tocancel_estimated_value_of_contract">Estimated Value of Material({{$claimantinformations[0]->currency}}): </label>
      @if ($errors->has('tocancel_estimated_value_of_contract'))
      <span class="invalid-feedback" role="alert">
        <strong>{{ $errors->first('tocancel_estimated_value_of_contract') }}</strong>
...
<div class="row">
  ...
  <div class="col-md-6"> 
    <div class="form-group">
      <input type="text" onkeypress="return isNumberKey(event)"  id="damage_with_interest"  value="{{ number_format((float)$ReliefRequest->damage_with_interest, 2, '.', '') }}" class="form-control{{ $errors->has('damage_with_interest') ? ' is-invalid' : '' }}" name="damage_with_interest" >
      @if ($claimantinformations[0]->currency =='INR') 
      <label class="form-control-placeholder" for="damage_with_interest">Total Claim (INR)<span style="color: red">*</span>:</label>
      @else
      <label class="form-control-placeholder" for="damage_with_interest">Total Claim (USD)<span style="color: red">*</span>:</label>
...
<div class="row">
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="text"    id="claim_for_contract_price" value="{{ number_format((float)$ReliefRequest->claim_for_contract_price, 2, '.', '') }}" class="form-control{{ $errors->has('claim_for_contract_price') ? ' is-invalid' : '' }}" name="claim_for_contract_price" >
     <label class="form-control-placeholder" for="claim_for_contract_price">Damages:</label>
     @if ($errors->has('claim_for_contract_price'))
     <span class="invalid-feedback" role="alert">
      <strong>{{ $errors->first('claim_for_contract_price') }}</strong>
...
<div class="col-md-4"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)"  id="claim_for_contract_price_interest" value="{{$ReliefRequest->claim_for_contract_price_interest}}" class="form-control{{ $errors->has('claim_for_contract_price_interest') ? ' is-invalid' : '' }}" name="claim_for_contract_price_interest" >
    <label class="form-control-placeholder" for="claim_for_contract_price_interest">Interest (%): </label>
    @if ($errors->has('claim_for_contract_price_interest'))
    <span class="invalid-feedback" role="alert">
      <strong>{{ $errors->first('claim_for_contract_price_interest') }}</strong>
...
<div class="col-md-4"> 
  <div class="form-group">
   <label class="form-control-placeholder" for="refund_withoutinterest" style="margin-left: 18px;">Without Interest</label>
   <input type="checkbox" class="form-control" id="refund_withoutinterest"  name="refund_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->refund_withoutinterest == 'yes' ? 'checked' : ''}}>
 </div>
</div>
