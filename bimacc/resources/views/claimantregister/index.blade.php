        ...
        <tbody>
          ...
          <tr>
            ...
            <tr>
              ...
              <td>
                <form action="{{ route('claimantregister.destroy',$register->id) }}" method="POST"> 

                 <a class="btn btn-info" title="show" href="{{ route('claimantregister.show',$register->id) }}"><i class="fas fa-eye">Show</i></a>        
