  <div class="row register-form" style="pointer-events: none;">
    ...
    <div class="col-md-4" > 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control" id="claim_for_refund_of_fare_or_freight"  name="claim_for_refund_of_fare_or_freight" style="width:7%" value="yes"  {{ $details->claim_for_refund_of_fare_or_freight == 'yes' ? 'checked' : ''}}>
     </div>

   </div>
   <div class="col-md-4">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)" id="claim_reinstatement" class="form-control{{ $errors->has('claim_reinstatement') ? ' is-invalid' : '' }}" name="claim_reinstatement" value="{{ number_format((float)$details->claim_reinstatement, 2, '.', '') }}">
...
<div class="col-md-4">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="claimforontractprice" class="form-control{{ $errors->has('claimforontractprice') ? ' is-invalid' : '' }}" name="claimforontractprice"value="{{ number_format((float)$details->claimforontractprice, 2, '.', '') }}">
...
<div class="row"  id="corporate_checkbox">
  <div class="col-md-4"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="claim_for_refund_of_fare_or_freight_interest"  name="claim_for_refund_of_fare_or_freight_interest" style="width:7%" value="yes"  {{ $details->claim_for_refund_of_fare_or_freight_interest == 'yes' ? 'checked' : ''}}>
    </div>
...
<div class="row" id="corporate_checkbox">
  <div class="col-md-4"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="claim_for_payment_of_damages"  name="claim_for_payment_of_damages" style="width:7%" value="yes"  {{ $details->claim_for_payment_of_damages == 'yes' ? 'checked' : ''}}>
    </div>
...
<div class="row" id="corporate_checkbox">
  <div class="col-md-4"  > 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="subrogation_value"  name="subrogation_value" style="width:7%" value="yes"  {{ $details->subrogation_value == 'yes' ? 'checked' : ''}}>
    </div>

  </div>
  <div class="col-md-4">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="demand_to_stop_infringement_select" class="form-control{{ $errors->has('demand_to_stop_infringement_select') ? ' is-invalid' : '' }}" name="demand_to_stop_infringement_select" value="{{ number_format((float)$details->demand_to_stop_infringement_select, 2, '.', '') }}">
...
<div class="row" id="corporate_checkbox">
  <div class="col-md-4"  > 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="claim_for_demurrages"  name="claim_for_demurrages" style="width:7%" value="yes"  {{ $details->claim_for_demurrages == 'yes' ? 'checked' : ''}}>
    </div>
...
<div class="row">
  <div class="col-md-4" id="corporate_checkbox"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="damage_amount"  name="damage_amount" style="width:7%" value="yes"  {{ $details->damage_amount == 'yes' ? 'checked' : ''}}>
    </div>
...
<div class="row" id="corporate_checkbox">
  <div class="col-md-4"  > 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="value_claims"  name="value_claims" style="width:7%" value="yes"  {{ $details->value_claims == 'yes' ? 'checked' : ''}}>
    </div>
  ...
  <div class="col-md-4">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="demand_for_licence_fee" class="form-control{{ $errors->has('demand_for_licence_fee') ? ' is-invalid' : '' }}" name="demand_for_licence_fee" value="{{ number_format((float)$details->demand_for_licence_fee, 2, '.', '') }}">
...
<div class="row">
  <div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="demand_for_licence_fee_interest"  name="demand_for_licence_fee_interest" style="width:9%" value="yes"  {{ $details->demand_for_licence_fee_interest == 'yes' ? 'checked' : ''}}>
    </div>

  </div>
  <div class="col-md-3">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="for_allotment_of_shares_stock" class="form-control{{ $errors->has('for_allotment_of_shares_stock') ? ' is-invalid' : '' }}" name="for_allotment_of_shares_stock" value="{{ number_format((float)$details->for_allotment_of_shares_stock, 2, '.', '') }}">
...
<div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="cancellation_license_value"  name="cancellation_license_value" style="width:9%" value="yes"  {{ $details->cancellation_license_value == 'yes' ? 'checked' : ''}}>
    </div>

  </div>
  <div class="col-md-3">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="demand_to_surrender_infringed_materials" class="form-control{{ $errors->has('demand_to_surrender_infringed_materials') ? ' is-invalid' : '' }}" name="demand_to_surrender_infringed_materials" value="{{ number_format((float)$details->demand_to_surrender_infringed_materials, 2, '.', '') }}">
...
>
  ...
  <div class="col-md-3">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="cancellation_license" class="form-control{{ $errors->has('cancellation_license') ? ' is-invalid' : '' }}" name="cancellation_license" value="{{ number_format((float)$details->cancellation_license, 2, '.', '') }}">
...
<div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="frightrefundamountinerest"  name="frightrefundamountinerest" style="width:9%" value="yes"  {{ $details->frightrefundamountinerest == 'yes' ? 'checked' : ''}}>
    </div>

  </div>
  <div class="col-md-3">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="value_infringing_withoutinterest" class="form-control{{ $errors->has('value_infringing_withoutinterest') ? ' is-invalid' : '' }}" name="value_infringing_withoutinterest" value="{{ number_format((float)$details->value_infringing_withoutinterest, 2, '.', '') }}">
...
<div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="damages_for_breach_of_contract_interest"  name="damages_for_breach_of_contract_interest" style="width:9%" value="yes"  {{ $details->damages_for_breach_of_contract_interest == 'yes' ? 'checked' : ''}}>
    </div>
  ...
  <div class="form-group">
   ...
   <input type="text" onkeypress="return isNumberKey(event)"  id="general_meetings" class="form-control{{ $errors->has('general_meetings') ? ' is-invalid' : '' }}" name="general_meetings" value="{{ number_format((float)$details->general_meetings, 2, '.', '') }}">
...
<div class="row">
  ...
  <label class="form-control-placeholder" for="frightamountwithpoutinterest" style="margin-left: 28px;">Cancellation of Allotment
      ...
      <input type="checkbox" class="form-control" id="frightamountwithpoutinterest"  name="frightamountwithpoutinterest" style="width:9%" value="yes"  {{ $details->frightamountwithpoutinterest == 'yes' ? 'checked' : ''}}>
    </div>
  ...
  <div class="form-group">
   ...
   <input type="text" onkeypress="return isNumberKey(event)"  id="for_cancellation_of_allotments" class="form-control{{ $errors->has('for_cancellation_of_allotments') ? ' is-invalid' : '' }}" name="for_cancellation_of_allotments" value="{{ number_format((float)$details->for_cancellation_of_allotments, 2, '.', '') }}">
...
<div class="col-md-3"> 
  ...
  <label class="form-control-placeholder" for="termination" style="margin-left: 28px;">Modification/ Annulment of minutes
      ...
      <input type="checkbox" class="form-control" id="termination"  name="termination" style="width:9%" value="yes"  {{ $details->termination == 'yes' ? 'checked' : ''}}>
    </div>
  ...
  <div class="form-group">
   ...
   <input type="text" onkeypress="return isNumberKey(event)"  id="value_claims_interest" class="form-control{{ $errors->has('value_claims_interest') ? ' is-invalid' : '' }}" name="value_claims_interest" value="{{ number_format((float)$details->value_claims_interest, 2, '.', '') }}">
...
<div class="row">
  <div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="claim_for_consideration_amount"  name="claim_for_consideration_amount" style="width:9%" value="yes"  {{ $details->claim_for_consideration_amount == 'yes' ? 'checked' : ''}}>
    </div>
...
<div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="claim_for_consideration_amount_interest"  name="claim_for_consideration_amount_interest" style="width:9%" value="yes"  {{ $details->claim_for_consideration_amount_interest == 'yes' ? 'checked' : ''}}>
    </div>

  </div>
  <div class="col-md-3">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="compel_or_cancel_push_or_put_options" class="form-control{{ $errors->has('compel_or_cancel_push_or_put_options') ? ' is-invalid' : '' }}" name="compel_or_cancel_push_or_put_options" value="{{ number_format((float)$details->compel_or_cancel_push_or_put_options, 2, '.', '') }}">
...
<div class="row">
  <div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="eid_claim_for_contract_price"  name="eid_claim_for_contract_price" style="width:9%" value="yes"  {{ $details->eid_claim_for_contract_price == 'yes' ? 'checked' : ''}}>
    </div>

  </div>
<div class="col-md-3">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="for_company_to_buy_back_of_shares" class="form-control{{ $errors->has('for_company_to_buy_back_of_shares') ? ' is-invalid' : '' }}" name="for_company_to_buy_back_of_shares" value="{{ number_format((float)$details->for_company_to_buy_back_of_shares, 2, '.', '') }}">
...
<div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="eid_claim_for_contract_price_interest"  name="eid_claim_for_contract_price_interest" style="width:9%" value="yes"  {{ $details->eid_claim_for_contract_price_interest == 'yes' ? 'checked' : ''}}>
    </div>

  </div>
<div class="col-md-3">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="demand_valuation_of_shares" class="form-control{{ $errors->has('demand_valuation_of_shares') ? ' is-invalid' : '' }}" name="demand_valuation_of_shares" value="{{ number_format((float)$details->demand_valuation_of_shares, 2, '.', '') }}">
...
<div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="eid_claim_for_refund_withoutinterest"  name="eid_claim_for_refund_withoutinterest" style="width:9%" value="yes"  {{ $details->eid_claim_for_refund_withoutinterest == 'yes' ? 'checked' : ''}}>
    </div>
...
<div class="col-md-3">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="chairman_and_key_employees" class="form-control{{ $errors->has('chairman_and_key_employees') ? ' is-invalid' : '' }}" name="chairman_and_key_employees" value="{{ number_format((float)$details->chairman_and_key_employees, 2, '.', '') }}">
...
<div class="col-md-3">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="cargo_nature" class="form-control{{ $errors->has('cargo_nature') ? ' is-invalid' : '' }}" name="cargo_nature" value="{{$details->cargo_nature}}">
...
<div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="claim_for_escalation_of_costs"  name="claim_for_escalation_of_costs" style="width:9%" value="yes"  {{ $details->claim_for_escalation_of_costs == 'yes' ? 'checked' : ''}}>
    </div>
...
<div class="col-md-3">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="for_enforcement_of_preferential_rights" class="form-control{{ $errors->has('for_enforcement_of_preferential_rights') ? ' is-invalid' : '' }}" name="for_enforcement_of_preferential_rights" value="{{ number_format((float)$details->for_enforcement_of_preferential_rights, 2, '.', '') }}">
...
<div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="claim_for_escalation_of_costs_withoutinterest"  name="claim_for_escalation_of_costs_withoutinterest" style="width:9%" value="yes"  {{ $details->claim_for_escalation_of_costs_withoutinterest == 'yes' ? 'checked' : ''}}>
    </div>

  </div> 
 <div class="col-md-3">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="demand_to_move_resolutions" class="form-control{{ $errors->has('demand_to_move_resolutions') ? ' is-invalid' : '' }}" name="demand_to_move_resolutions" value="{{ number_format((float)$details->demand_to_move_resolutions, 2, '.', '') }}">
...
<div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="aggregate_value_of_debentures"  name="aggregate_value_of_debentures" style="width:9%" value="yes"  {{ $details->aggregate_value_of_debentures == 'yes' ? 'checked' : ''}}
>
    </div>
  ...
  <div class="col-md-3">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="agreement_value" class="form-control{{ $errors->has('agreement_value') ? ' is-invalid' : '' }}" name="agreement_value" value="{{ number_format((float)$details->agreement_value, 2, '.', '') }}">
...
<div class="col-md-3"> 
  ...
  <div class="col-md-3">  
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="claim_for_damages_interest" class="form-control{{ $errors->has('claim_for_damages_interest') ? ' is-invalid' : '' }}" name="claim_for_damages_interest" value="{{ number_format((float)$details->claim_for_damages_interest, 2, '.', '') }}">
...
<div class="col-md-3"> 
    <div class="form-group">
      ...
      <input type="checkbox" class="form-control" id="claim_for_specific_performance"  name="claim_for_specific_performance" style="width:9%" value="yes"  {{ $details->claim_for_specific_performance == 'yes' ? 'checked' : ''}}
>
    </div>
  ...
  <div class="col-md-3"> 
    <div class="form-group">
      <input type="text" onkeypress="return isNumberKey(event)"  id="damageamountinterestwithinterest"  class="form-control{{ $errors->has('damageamountinterestwithinterest') ? ' is-invalid' : '' }}" name="damageamountinterestwithinterest" value="{{ number_format((float)$details->damageamountinterestwithinterest, 2, '.', '') }}">
...
<div class="row">
  ...
  <div class="col-md-3"> 
    <div class="form-group">
     ...
     <input type="checkbox" class="form-control" id="freightrefundamount"  name="freightrefundamount" style="width:9%" value="yes"  {{ $details->freightrefundamount == 'yes' ? 'checked' : ''}}
>
   </div>
 ...
 <div class="col-md-3"> 
    <div class="form-group">
      <input type="text" onkeypress="return isNumberKey(event)"  id="nature_and_details_of_cargo"  class="form-control{{ $errors->has('nature_and_details_of_cargo') ? ' is-invalid' : '' }}" name="nature_and_details_of_cargo" value="{{ number_format((float)$details->nature_and_details_of_cargo, 2, '.', '') }}">
