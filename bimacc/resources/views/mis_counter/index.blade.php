...
<div class="container con">
 ...
 <div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Counter Claim Details</h6>
  </div>
  <div class="card">
                ...
                <div class="card-body">
                 ...
                 <div class="row">
                  <div class="col-12 col-md-12 col-lg-12">
                    ...
                    <form  action="{{ route('miscounter.store') }}" method="POST" name="new_entry" enctype="multipart/form-data" autocomplete="off" id="claimantinformationform">
           {{ csrf_field() }}
