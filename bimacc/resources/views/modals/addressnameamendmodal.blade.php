...
<div class="modal fade" id="addressnameamendmodal{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="addressnameamendmodal" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addressnameamendmodal">Change of Name</h5>
