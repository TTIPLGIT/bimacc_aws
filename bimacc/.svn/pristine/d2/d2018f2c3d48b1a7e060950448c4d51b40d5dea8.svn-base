...
<li>
   ...
   <a type="button" href="{{url('home')}}"    style=" float:right !important; background-color: white!important; color:  #602e9e !important; border-radius:30px;" class="btn btn-primary"  title="Home"><i class="fa fa-home"></i></a>
 </li>
</div>
</nav>
...
<a type="button" href="{{route('login')}}" id="reg" style="margin-top:10px !important; float:right !important;  font: 18px Arial, sans-serif!important; padding:10px !important; background-color:#ffc002 !important;  color: black !important; border-radius:25px;" class="btn-primary"  title="Register / Login"><b>REGISTER / LOGIN</b></a>    
  ...
  <div id="footer">
   ...
   </span02> <span>Copyright © <a href="{{route('home')}}">Lexquisite.</a> {{ now()->year }}</span> <span01 style="color:orange !important;  padding: 15px !important;">  
    </div>
  </div>
