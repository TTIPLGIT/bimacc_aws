...
<form  id="claimdetails_update_form" name="claimdetails_update_form" method="POST" style="width: 100%;" >
  ...
  <div class="row register-form">
    ...
    <div class="row">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <input type="date"  id="date_of_notification" class="datechk form-control{{ $errors->has('date_of_notification') ? ' is-invalid' : '' }}" name="date_of_notification"  value="{{$claimDetail->date_of_notification}}">
         <label class="form-control-placeholder" for="date_of_notification">Date of Notification: </label>
         @if ($errors->has('date_of_notification'))
         <span class="invalid-feedback" role="alert">
          <strong>{{ $errors->first('date_of_notification') }}</strong>
  ...
  <div class="row">
    <div class="col-md-6"> 
      <div class="form-group">
       <input type="date"  id="date_of_tender" class="datechk form-control{{ $errors->has('date_of_tender') ? ' is-invalid' : '' }}" name="date_of_tender"  value="{{$claimDetail->date_of_tender}}" >
       <label class="form-control-placeholder" for="date_of_tender">Date of Tender: </label>
       @if ($errors->has('date_of_tender'))
       <span class="invalid-feedback" role="alert">
        <strong>{{ $errors->first('date_of_tender') }}</strong>
