...
$count=0;
@endphp
    @foreach ($respodentcounterclaiminsurance_claim as $insurance_claims)
...
@endphp
    <div class="row">
<div class="col-md-1"><input class="form-control" value="{{$count}}"  type="text" disabled ><label class="form-control-placeholder">Sl. No.</label></div>
         <div class="col-md-2"> 
