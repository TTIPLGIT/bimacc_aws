       ...
       <td style="border: none;">
        <span title="{{$resclaimNoticeStageDocuments1->remarks}}" >
         <a href="{{ route('getClaimPetionStageDocuments',$resclaimNoticeStageDocuments1->documentid) }}" target="blank" download>
          ...
          <!-- {{$claimNoticeStageDocuments1->remarks}} -->
        </a></span>
...
<td>
  @if($ClaimNoticeStages->claimantnotice_stage_status=="Award Reserved By Arbitrator" ||  $ClaimNoticeStages->claimantnotice_stage_status=="Additional Payment Paid")
