...
class ReliefRequestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //echo $request->specific_perf; exit;

        $form_data = array(
            'freightrefundamount' => $request->freightrefundamount,
            'frightrefundamountinerest' => $request->frightrefundamountinerest,
            ...
            'claim_for_payment_of_damages_withoutinterest' => $request->claim_for_payment_of_damages_withoutinterest,
            'claim_for_refund_of_fare_or_freight_withoutinterest' => $request->claim_for_refund_of_fare_or_freight_withoutinterest,
            'claim_for_payment_of_freight_withoutinterest' => $request->claim_for_payment_of_freight_withoutinterest,
            ...
            'claim_for_damages_withoutinterest'=> $request->claim_for_damages_withoutinterest,
...
// media
            ...
            'claim_against_members_for_damages_and_nuisance_check'=> $request->claim_against_members_for_damages_and_nuisance_check,
...
return response()->json(['success' => 'Relief Request Added Successfully.']);
}
public function respondantrelief(Request $request)
{
...
public function updatereliefrequest(Request $request)
{
    ...
    $reliefrequestid = $request->reliefrequestid;
        //return count($request->contrac$request->reliefrequestidt;_price); exit;
    //dd($reliefrequestid);
        //$reliefrequestid = $request->reliefrequestid;
    if ($reliefrequestid != "") 
    {
        ...
        $form_data = array(
         ...
         //  //$request->challenging_cancellation_of_policy_interest,
         // //'challenging_cancellation_of_policy_interest'=> //$request->challenging_cancellation_of_policy_withoutinterest,
         // 'challenging_cancellation_of_policy_withoutinterest'=> $request->challenging_cancellation_of_policy_withoutinterest,
         'subrogation_value_interest'=> $request->subrogation_value_interest,
         'subrogation_value_withoutinterest'=> $request->subrogation_value_withoutinterest,
         'value_performance'=> $request->value_performance,
