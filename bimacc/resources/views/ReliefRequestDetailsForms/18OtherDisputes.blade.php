...
<form  name="reliefrequest_form" id="reliefrequest_form" method="POST" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="claim_for_consideration_amount_withoutinterest" class="form-control" style="width:7%" name="claim_for_consideration_amount_withoutinterest" value="yes" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="refund_withoutinterest" class="form-control" style="width:7%" name="refund_withoutinterest" value="yes" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="claim_for_payment_of_damages_interest" class="form-control" style="width:7%" name="claim_for_payment_of_damages_interest" value="yes" >
      ...
      <div class="row">
        ...
        <div class="col-md-4"> 
          <div class="form-group">
            <input type="text" onkeypress="return isNumberKey(event)"  id="value_performance_int" class="form-control{{ $errors->has('value_performance_int') ? ' is-invalid' : '' }}" name="value_performance_int" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="value_performance_withoutint" class="form-control" style="width:7%" name="value_performance_withoutint" value="yes" >
...
<form  name="reliefrequest_update_form" id="reliefrequest_update_form" method="POST" >
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_for_consideration_amount_withoutinterest" style="margin-left: 18px;" >Without Interest(%)</label>
    <input type="checkbox" id="claim_for_consideration_amount_withoutinterest" class="form-control" style="width:7%" name="claim_for_consideration_amount_withoutinterest" value="yes" {{ $ReliefRequest->claim_for_consideration_amount_withoutinterest == 'yes' ? 'checked' : ''}}>
      ...
      <div class="row">
            <div class="col-md-4"> 
          <div class="form-group">
            <input type="text" onkeypress="return isNumberKey(event)"  id="claim_for_refund" class="form-control{{ $errors->has('claim_for_refund') ? ' is-invalid' : '' }}" name="claim_for_refund"  value="{{ number_format((float)$ReliefRequest->claim_for_refund, 2, '.', '') }}">
            <label class="form-control-placeholder" for="claim_for_refund">Refund Amount({{$claimantinformations[0]->currency}}):</label>
            @if ($errors->has('claim_for_refund'))
            <span class="invalid-feedback" role="alert">
              <strong>{{ $errors->first('claim_for_refund') }}</strong>
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="refund_withoutinterest" style="margin-left: 18px;" >Without Interest(%)</label>
    <input type="checkbox" id="refund_withoutinterest" class="form-control" style="width:7%" name="refund_withoutinterest" value="yes" {{ $ReliefRequest->refund_withoutinterest == 'yes' ? 'checked' : ''}}>
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_for_payment_of_damages_interest" style="margin-left: 18px;" >Without Interest(%)</label>
    <input type="checkbox" id="claim_for_payment_of_damages_interest" class="form-control" style="width:7%" name="claim_for_payment_of_damages_interest" value="yes" {{ $ReliefRequest->claim_for_payment_of_damages_interest == 'yes' ? 'checked' : ''}}>
      ...
      <div class="row">
        ...
        <div class="col-md-4"> 
          <div class="form-group">
            <input type="text" onkeypress="return isNumberKey(event)"  id="value_performance_int" class="form-control{{ $errors->has('value_performance_int') ? ' is-invalid' : '' }}" name="value_performance_int"  value="{{ $ReliefRequest->value_performance_int }}">
            <label class="form-control-placeholder" for="value_performance_int">With Interest(%):</label>
            @if ($errors->has('value_performance_int'))
            <span class="invalid-feedback" role="alert">
              <strong>{{ $errors->first('value_performance_int') }}</strong>
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="value_performance_withoutint" style="margin-left: 18px;" >Without Interest(%)</label>
    <input type="checkbox" id="value_performance_withoutint" class="form-control" style="width:7%" name="value_performance_withoutint" value="yes" {{ $ReliefRequest->claim_for_payment_of_damages_interest == 'yes' ? 'checked' : ''}}>
 ...
 <div class="col-md-4"> 
  ...
  <div class="form-group">
     <label class="form-control-placeholder" for="value_claims_withoutinterest" style="margin-left: 18px;" >Without Interest(%)</label>
    <input type="checkbox" class="form-control" id="value_claims_withoutinterest"  name="value_claims_withoutinterest" style="width:7%" value="yes"  {{ $ReliefRequest->claim_for_consideration_amount_withoutinterest == 'yes' ? 'checked' : ''}}>
  </div>
...
<script>
  ...
  if ($(this).prop('checked')) {
    ...
    $('#claim_for_payment_of_damages_interest').on('click', function () {
  if ($(this).prop('checked')) {
