    ...
    <form  id="sample_form" name="sample_form" method="POST" style="    width: 100%;" >
      ...
      <div class="row">
        <div class="col-md-3"> 
          <div class="form-group">
            <input type="date" id="partnership_deed_date" class="datechk form-control{{ $errors->has('partnership_deed_date') ? ' is-invalid' : '' }}" name="partnership_deed_date" >
        ...
        <div class="col-md-3"> 
         <div class="form-group">
           <input type="date" id="date_of_reconstitution" class="datechk form-control{{ $errors->has('date_of_reconstitution') ? ' is-invalid' : '' }}" name="date_of_reconstitution"  >
      ...
      <div class="col-md-3"> 
       <div class="form-group">
         <input type="date" id="date_of_dissolution" class="datechk form-control{{ $errors->has('date_of_dissolution') ? ' is-invalid' : '' }}" name="date_of_dissolution" >
    ...
    <div class="col-md-3"> 
     <div class="form-group">
       <input type="date" id="date_of_agreement" class="datechk form-control{{ $errors->has('date_of_agreement') ? ' is-invalid' : '' }}" name="date_of_agreement" >
...
<form  id="claimdetails_update_form" name="claimdetails_update_form" method="POST" style="width: 100%;" >
 ...
 -->
  ...
  <div class="row">
    <div class="col-md-3"> 
      <div class="form-group">
        ...
        <input type="date" id="partnership_deed_date" class="datechk form-control{{ $errors->has('partnership_deed_date') ? ' is-invalid' : '' }}" name="partnership_deed_date"  value="{{$claimDetail->partnership_deed_date}}">
        <label class="form-control-placeholder" for="partnership_deed_date">Partnership Deed Date:</label>
        @if ($errors->has('partnership_deed_date'))
        <span class="invalid-feedback" role="alert">
          <strong>{{ $errors->first('partnership_deed_date') }}</strong>
    ...
    <div class="col-md-3"> 
     <div class="form-group">
       <input type="date" id="date_of_reconstitution" class="datechk form-control{{ $errors->has('date_of_reconstitution') ? ' is-invalid' : '' }}" name="date_of_reconstitution"  value="{{$claimDetail->date_of_reconstitution}}" >
       <label class="form-control-placeholder" for="date_of_reconstitution">Date of Reconstitution:</label>
       @if ($errors->has('date_of_reconstitution'))
       <span class="invalid-feedback" role="alert">
        <strong>{{ $errors->first('date_of_reconstitution') }}</strong>
  ...
  <div class="col-md-3"> 
   <div class="form-group">
     <input type="date" id="date_of_dissolution" class="datechk form-control{{ $errors->has('date_of_dissolution') ? ' is-invalid' : '' }}" name="date_of_dissolution"  value="{{$claimDetail->date_of_dissolution}}">
     <label class="form-control-placeholder" for="date_of_dissolution">Date of Dissolution:</label>
     @if ($errors->has('date_of_dissolution'))
     <span class="invalid-feedback" role="alert">
      <strong>{{ $errors->first('date_of_dissolution') }}</strong>
...
<div class="col-md-3"> 
 <div class="form-group">
   <input type="date" id="date_of_agreement" class="datechk form-control{{ $errors->has('date_of_agreement') ? ' is-invalid' : '' }}" name="date_of_agreement"  value="{{$claimDetail->date_of_agreement}}">
   <label class="form-control-placeholder" for="date_of_agreement">Date of Agreement: </label>
   @if ($errors->has('date_of_agreement'))
   <span class="invalid-feedback" role="alert">
    <strong>{{ $errors->first('date_of_agreement') }}</strong>
