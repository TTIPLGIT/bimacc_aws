...
<form  name="reliefrequest_form" id="reliefrequest_form" method="POST" >
  ...
  <div class="col-md-3"> 
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"  id="rbenefit_withinterest" class="form-control{{ $errors->has('benefit_withinterest') ? ' is-invalid' : '' }}" name="benefit_withinterest" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control" id="rbenefit_withoutinterest"  name="benefit_withoutinterest" style="width:9%"  value="yes">
  </div>
</div>
...
<div class="row">
 ...
 <div class="col-md-4"> 
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="raverage_value_interest" class="form-control{{ $errors->has('average_value_interest') ? ' is-invalid' : '' }}" name="average_value_interest"  >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control" id="raverage_value_withoutinterest"  name="average_value_withoutinterest" style="width:7%" value="yes">
  </div>
...
$('#rbenefit_withoutinterest').on('click', function () {
  if ($(this).prop('checked')) {
                document.getElementById("rbenefit_withinterest").disabled = true;
                //$('#demand_for_licence_fee_interest').disabled();
                $('#rbenefit_withinterest').val("");

            } else {
               document.getElementById("rbenefit_withinterest").disabled = false;
                $('#rbenefit_withinterest').val("");
            }
});
...
<script type="text/javascript">
$('#raverage_value_withoutinterest').on('click', function () {
  if ($(this).prop('checked')) {
                document.getElementById("raverage_value_interest").disabled = true;
                //$('#demand_for_licence_fee_interest').disabled();
                $('#raverage_value_interest').val("");

            } else {
               document.getElementById("raverage_value_interest").disabled = false;
                $('#raverage_value_interest').val("");
            }
});
