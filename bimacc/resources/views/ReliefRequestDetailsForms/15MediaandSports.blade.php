...
<form  name="reliefrequest_update_form" id="reliefrequest_update_form" method="POST" >
 ...
 -->          <div class="form-group text-center" style="margin-bottom: 1.4em !important;">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="money_claim_amount_withoutinterest" style="margin-left: 18px;">Without Interest</label>
         <input type="checkbox" class="form-control" id="money_claim_amount_withoutinterest"  name="money_claim_amount_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->money_claim_amount_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
   ...
   <div class="row">
    ...
    <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="claim_restrain" style="margin-left: 18px;">Claim to Restrain from Promotion of Competing Product</label>
         <input type="checkbox" class="form-control" id="claim_restrain"  name="claim_restrain" style="width:7%" value="yes" {{ $ReliefRequest->claim_restrain == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
    ...
    <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="claim_for_withoutinterest" style="margin-left: 18px;">Without Interest</label>
         <input type="checkbox" class="form-control" id="claim_for_withoutinterest"  name="claim_for_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->claim_for_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>  
     </div> 
      <div class="row">
    ...
    <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="claim_for_royalty_withoutinterest" style="margin-left: 18px;">Without Interest</label>
         <input type="checkbox" class="form-control" id="claim_for_royalty_withoutinterest"  name="claim_for_royalty_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->claim_for_royalty_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>  
     </div> 
     <div class="row">
      ...
      <div class="col-md-6"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="cancellation_of_agreement"  name="cancellation_of_agreement" style="width:5%" value="yes" {{ $ReliefRequest->cancellation_of_agreement == 'yes' ? 'checked' : ''}}>
       </div>
     </div> 
      <div class="col-md-6"> 
      <div class="form-group">
