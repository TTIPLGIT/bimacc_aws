                ...
                <div class="card-body">
                 ...
                 <div class="row">
                  <div class="col-12 col-md-12 col-lg-12">
                    ...
                    <form  action="{{ route('misclaimnotice.store') }}" method="POST" name="new_entry" enctype="multipart/form-data" autocomplete="off" id="claimantinformationform">
           {{ csrf_field() }}
           ...
           <div class="col-md-6">
              <div class="form-group">
               <select class="form-control" name="claimant_type" id="claimant_type">
                <option value="">Claimnant Type</option>
              ...
              <label class="form-control-placeholder" for="claimant_type">Claimant Type</label> 
            </div>
          </div>
           <div class="col-md-6">
              <div class="form-group">
...
var fields = "#from_date, #received_date,#disputecategory";
