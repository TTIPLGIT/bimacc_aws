...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="rate_of_penal_interest" class="form-control" style="width:7%" name="rate_of_penal_interest"  value="yes" onclick="document.getElementById('rate_of_penal_interest').disabled=this.checked;" >
...
<form  name="reliefrequest_update_form" id="reliefrequest_update_form" method="POST" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="rate_of_interest" class="form-control" style="width:7%" name="rate_of_interest"  value="yes "{{ $ReliefRequest->rate_of_interest == 'yes' ? 'checked' : ''}}  >
...
<div class="col-md-4"> 
  <div class="form-group">
    <label class="form-control-placeholder" id="amount_of_debt" for="amount_of_debt" style="margin-left: 18px;">Enforcement of Guarantees</label>
    <input type="checkbox" id="amount_of_debt" class="form-control" style="width:7%" name="amount_of_debt"  value="yes"{{ $ReliefRequest->amount_of_debt == 'yes' ? 'checked' : ''}}  >
...
<div class="col-md-4"> 
  <div class="form-group">
    <label class="form-control-placeholder" id="damages_rs" for="damages_rs" style="margin-left: 18px;">Future Interest During Pendency of Arbitration</label>
    <input type="checkbox" id="damages_rs" class="form-control" style="width:7%" name="damages_rs"  value="yes"{{ $ReliefRequest->damages_rs == 'yes' ? 'checked' : ''}}  >
...
<div class="col-md-4"> 
  <div class="form-group">
    <label class="form-control-placeholder" id="rate_of_penal_interest" for="rate_of_penal_interest" style="margin-left: 26px;">Future Interest from the Date of Award</label>
    <input type="checkbox" id="rate_of_penal_interest" class="form-control" style="width:7%" name="rate_of_penal_interest"  value="yes"{{ $ReliefRequest->rate_of_penal_interest == 'yes' ? 'checked' : ''}} >
