...
<form  id="claimdetails_update_form" name="claimdetails_update_form" method="POST" style="width: 100%;" >
  @csrf  
        ...
        <div class="row">
           <div class="col-md-4"> 
            <div class="form-group">
             <input type="date"  id="date_of_contract" class="datechk form-control{{ $errors->has('date_of_contract') ? ' is-invalid' : '' }}" name="date_of_contract" value="{{$claimDetail->date_of_contract}}">
             <label class="form-control-placeholder" for="date_of_contract">Contract Date:</label>
             @if ($errors->has('date_of_contract'))
             <span class="invalid-feedback" role="alert">
              <strong>{{ $errors->first('date_of_contract') }}</strong>
        ...
        <div class="col-md-4"> 
            <div class="form-group">
             <input type="text"  onkeypress="return isNumberKey(event)"  id="contractdate" class="form-control{{ $errors->has('contractdate') ? ' is-invalid' : '' }}" name="contractdate" value="{{ number_format((float)$claimDetail->contractdate, 2, '.', '') }}">
             <label class="form-control-placeholder" for="contractdate">Contract Value({{$claimantinformations[0]->currency}}):</label>
             @if ($errors->has('contractdate'))
             <span class="invalid-feedback" role="alert">
              <strong>{{ $errors->first('contractdate') }}</strong>
