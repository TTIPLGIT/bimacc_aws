     ...
     <div class="row">
      <div class="col-md-4"> 
        <div class="form-group">
         <input type="text" id="carriername" value="{{ $details->carriername }}" class="form-control{{ $errors->has('carriername') ? ' is-invalid' : '' }}" name="carriername" >
    ...
    <div class="col-md-4"> 
      <div class="form-group">
        ...
        <input type="text" id="CharterParty" value="{{ $details->charterparty }}" class="form-control{{ $errors->has('CharterParty') ? ' is-invalid' : '' }}" name="charterparty" >
    ...
    <div class="col-md-4"> 
     <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"   id="pnrno" value="{{ $details->pnrno }}" class="form-control{{ $errors->has('pnrno') ? ' is-invalid' : '' }}" name="pnrno" >
  ...
  <div class="col-md-4"> 
    <div class="form-group">
      <input type="text" id="cargonature" value="{{ $details->cargonature }}" class="form-control{{ $errors->has('cargonature') ? ' is-invalid' : '' }}" name="cargonature" >
  ...
  <div class="col-md-4"> 
   <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="quantity" value="{{ $details->quantity }}" class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}" name="quantity" >
...
<div class="col-md-4"> 
  <div class="form-group">
   <input type="text" id="natureofincident"  value="{{ $details->natureofincident }}" class="form-control{{ $errors->has('natureofincident') ? ' is-invalid' : '' }}" name="natureofincident" >
