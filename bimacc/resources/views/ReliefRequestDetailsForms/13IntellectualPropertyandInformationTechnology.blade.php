...
<form  name="reliefrequest_form" id="reliefrequest_form" method="POST" >
  ...
  <div class="row register-form">
    <div class="col-md-12">
      ...
      <div class="col-md-3"> 
        <div class="form-group">
          <input type="text" onkeypress="return isNumberKey(event)"  id="demand_damages_for_infringement"  class="form-control{{ $errors->has('demand_damages_for_infringement') ? ' is-invalid' : '' }}" name="demand_damages_for_infringement" >
      ...
      <div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control" id="nature_of_property"  name="nature_of_property" style="width:9%"  value="yes"  >
       </div>
     </div>
  ...
  <div class="col-md-3"> 
    <div class="form-group">
      <input type="text" onkeypress="return isNumberKey(event)"  id="demand_for_licence_fee_interest" class="form-control{{ $errors->has('demand_for_licence_fee_interest') ? ' is-invalid' : '' }}" name="demand_for_licence_fee_interest"  >
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control" id="value_claims_withoutinterest"  name="value_claims_withoutinterest" style="width:9%" value="yes">
 </div>
...
<div class="col-md-3"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)"  id="damages_for_breach_of_contract_interest" class="form-control{{ $errors->has('damages_for_breach_of_contract_interest') ? ' is-invalid' : '' }}" name="damages_for_breach_of_contract_interest"  >
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control" id="damages_for_breach_of_contract_withoutinterest"  name="damages_for_breach_of_contract_withoutinterest" style="width:9%"  value="yes">
 </div>
</div>
</div>
<div class="row">
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control" id="value_infringing_withoutinterest"  name="value_infringing_withoutinterest" style="width:9%"  value="yes">
 </div>
</div>
...
<form  name="reliefrequest_update_form" id="reliefrequest_update_form" method="POST" >
  ...
  <div class="row register-form">
    <div class="col-md-12">
      ...
      <div class="col-md-3"> 
        <div class="form-group">
          <input type="text" onkeypress="return isNumberKey(event)"  id="demand_damages_for_infringement"  class="form-control{{ $errors->has('demand_damages_for_infringement') ? ' is-invalid' : '' }}" name="demand_damages_for_infringement" value="{{$ReliefRequest->demand_damages_for_infringement}}">
          <label class="form-control-placeholder" for="demand_damages_for_infringement">Interest %:</label>
          @if ($errors->has('demand_damages_for_infringement'))
          <span class="invalid-feedback" role="alert">
            <strong>{{ $errors->first('demand_damages_for_infringement') }}</strong>
      ...
      <div class="col-md-3"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="nature_of_property" style="margin-left: 18px;">Without Interest</label>
         <input type="checkbox" class="form-control" id="nature_of_property"  name="nature_of_property" style="width:9%"  value="yes" {{ $ReliefRequest->nature_of_property == 'yes' ? 'checked' : ''}} >
       </div>
     </div>
   ...
   <div class="col-md-3"> 
    <div class="form-group">
      <input type="text" onkeypress="return isNumberKey(event)"  id="rendition_of_accounts" class="form-control{{ $errors->has('rendition_of_accounts') ? ' is-invalid' : '' }}" name="rendition_of_accounts" value="{{ number_format((float)$ReliefRequest->rendition_of_accounts, 2, '.', '') }}" >
      <label class="form-control-placeholder" for="rendition_of_accounts">Value of License Fee({{$claimantinformations[0]->currency}}):</label>
      @if ($errors->has('rendition_of_accounts'))
      <span class="invalid-feedback" role="alert">
        <strong>{{ $errors->first('rendition_of_accounts') }}</strong>
  ...
  <div class="col-md-3"> 
    <div class="form-group">
      <input type="text" onkeypress="return isNumberKey(event)"  id="demand_for_licence_fee_interest" class="form-control{{ $errors->has('demand_for_licence_fee_interest') ? ' is-invalid' : '' }}" name="demand_for_licence_fee_interest"  value="{{$ReliefRequest->demand_for_licence_fee_interest}}">
      <label class="form-control-placeholder" for="demand_for_licence_fee_interest">Interest %:</label>
      @if ($errors->has('demand_for_licence_fee_interest'))
      <span class="invalid-feedback" role="alert">
        <strong>{{ $errors->first('demand_for_licence_fee_interest') }}</strong>
...
<div class="row">
  <div class="col-md-3"> 
    <div class="form-group">
     <label class="form-control-placeholder" for="cancellation_license" style="margin-left: 18px;margin-top: -8px;">Demand for Cancellation of License/ Assignment/ Agreement</label>
     <input type="checkbox" class="form-control" id="cancellation_license"  name="cancellation_license" style="width:9%"  value="yes" {{ $ReliefRequest->cancellation_license == 'yes' ? 'checked' : ''}}
     >
   </div>
 </div>
 <div class="col-md-4"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)"  id="cancellation_license_value"  class="form-control{{ $errors->has('cancellation_license_value') ? ' is-invalid' : '' }}" name="cancellation_license_value" value="{{ number_format((float)$ReliefRequest->cancellation_license_value, 2, '.', '') }}">
    <label class="form-control-placeholder" for="cancellation_license_value">Value of License/ Assignment Agreement({{$claimantinformations[0]->currency}}):</label>
    @if ($errors->has('cancellation_license_value'))
    <span class="invalid-feedback" role="alert">
      <strong>{{ $errors->first('cancellation_license_value') }}</strong>
...
<div class="col-md-3"> 
  <div class="form-group">
   <label class="form-control-placeholder" for="value_claims_withoutinterest" style="margin-left: 18px;">Without Interest</label>
   <input type="checkbox" class="form-control" id="value_claims_withoutinterest"  name="value_claims_withoutinterest" style="width:9%" value="yes" {{ $ReliefRequest->value_claims_withoutinterest == 'yes' ? 'checked' : ''}}
   >
 </div>
...
<div class="col-md-3"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)"  id="damages_for_breach_of_contract_interest" class="form-control{{ $errors->has('damages_for_breach_of_contract_interest') ? ' is-invalid' : '' }}" name="damages_for_breach_of_contract_interest"  value="{{$ReliefRequest->damages_for_breach_of_contract_interest}}">
    <label class="form-control-placeholder" for="damages_for_breach_of_contract_interest">Interest %:</label>
    @if ($errors->has('damages_for_breach_of_contract_interest'))
    <span class="invalid-feedback" role="alert">
      <strong>{{ $errors->first('damages_for_breach_of_contract_interest') }}</strong>
...
<div class="col-md-3"> 
  <div class="form-group">
   <label class="form-control-placeholder" for="damages_for_breach_of_contract_withoutinterest" style="margin-left: 18px;">Without Interest</label>
   <input type="checkbox" class="form-control" id="damages_for_breach_of_contract_withoutinterest"  name="damages_for_breach_of_contract_withoutinterest" style="width:9%"  value="yes" {{ $ReliefRequest->damages_for_breach_of_contract_withoutinterest == 'yes' ? 'checked' : ''}}
   >
 </div>
</div>
</div>
<div class="row">
 <div class="col-md-3"> 
  <div class="form-group">
   <label class="form-control-placeholder" for="demand_to_surrender_infringed_materials" style="margin-left: 18px;margin-top: -8px;">Demand to Surrender Infringing Material</label>
   <input type="checkbox" class="form-control" id="demand_to_surrender_infringed_materials"  name="demand_to_surrender_infringed_materials" style="width:9%"  value="yes" {{ $ReliefRequest->demand_to_surrender_infringed_materials == 'yes' ? 'checked' : ''}}
   >
 </div>
</div>
<div class="col-md-3"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)"  id="value_infringing" class="form-control{{ $errors->has('value_infringing') ? ' is-invalid' : '' }}" name="value_infringing" value="{{ number_format((float)$ReliefRequest->value_infringing, 2, '.', '') }}">
    <label class="form-control-placeholder" for="value_infringing">Value of Infringing Materials({{$claimantinformations[0]->currency}}):</label>
    @if ($errors->has('value_infringing'))
    <span class="invalid-feedback" role="alert">
      <strong>{{ $errors->first('value_infringing') }}</strong>
...
<div class="col-md-3"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)"  id="interest_amount" class="form-control{{ $errors->has('interest_amount') ? ' is-invalid' : '' }}" name="interest_amount" value="{{$ReliefRequest->interest_amount}}">
    <label class="form-control-placeholder" for="interest_amount">Interest %:</label>
    @if ($errors->has('interest_amount'))
    <span class="invalid-feedback" role="alert">
      <strong>{{ $errors->first('interest_amount') }}</strong>
...
<div class="col-md-3"> 
  <div class="form-group">
   <label class="form-control-placeholder" for="value_infringing_withoutinterest" style="margin-left: 18px;">Without Interest</label>
   <input type="checkbox" class="form-control" id="value_infringing_withoutinterest"  name="value_infringing_withoutinterest" style="width:9%"  value="yes" {{ $ReliefRequest->value_infringing_withoutinterest == 'yes' ? 'checked' : ''}}
   >
 </div>
</div>
...
<!-- onclick="document.getElementById('demand_for_licence_fee_interest').disabled=this.checked;" -->
@endforeach

@endif
<script type="text/javascript">
// $('#demand_for_licence_fee_withoutinterest').on('click', function () {
//   if ($(this).prop('checked')) {
//                 document.getElementById("demand_for_licence_fee_interest").disabled = true;
//                 //$('#demand_for_licence_fee_interest').disabled();
//                 $('#demand_for_licence_fee_interest').val("");

//             } else {
//                document.getElementById("demand_for_licence_fee_interest").disabled = false;
//                 $('#demand_for_licence_fee_interest').val("");
//             }
// });
$('#nature_of_property').on('click', function () {
  if ($(this).prop('checked')) {
    document.getElementById("demand_damages_for_infringement").disabled = true;
                //$('#demand_for_licence_fee_interest').disabled();
                $('#demand_damages_for_infringement').val("");

              } else {
               document.getElementById("demand_damages_for_infringement").disabled = false;
               $('#demand_damages_for_infringement').val("");
             }
           });
$('#demand_for_licence_fee_withoutinterest').on('click', function () {
...
$('#damages_for_breach_of_contract_withoutinterest').on('click', function () {
  if ($(this).prop('checked')) {
    document.getElementById("damages_for_breach_of_contract_interest").disabled = true;
                //$('#demand_for_licence_fee_interest').disabled();
                $('#damages_for_breach_of_contract_interest').val("");

              } else {
               document.getElementById("damages_for_breach_of_contract_interest").disabled = false;
               $('#damages_for_breach_of_contract_interest').val("");
             }
           });
