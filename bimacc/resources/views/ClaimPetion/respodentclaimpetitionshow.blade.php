...
@if($notice->isstageinitiated =='Y')
@if($ClaimNoticeStatusCount != 0)
@include('ClaimNoticeStage/respondantdocument')
@endif
...
<!--           Arbitrator Award Document Initiated.
          <table>
            @foreach ($AwardedDcouments as $key => $AwardedDcouments1)
            @if($AwardedDcouments1->id == $ClaimNoticeStages->id)
            <tr>
      ...
      Award:
         <table>
            ...
            <tr>
             ...
             <td style="border: none;">
               <a href="{{ route('getClaimPetionStageDocuments',$AdminAwardedDocuments1->documentid) }}"  download>
          ...
          <tr>
           <td style="border: none;">
            <span title="{{$claimNoticeStageDocuments1->remarks}}" >
             <a href="{{ route('getClaimPetionStageDocuments',$claimNoticeStageDocuments1->documentid) }}"  download>
        ...
        <tr>
         <td style="border: none;">
          <span title="{{$resclaimNoticeStageDocuments1->remarks}}" >
           <a href="{{ route('getClaimPetionStageDocuments',$resclaimNoticeStageDocuments1->documentid) }}"  download>
  ...
  <form action="{{ route('claimantrespondantaccess.destroy',$ClaimNoticeStages->id) }}" method="POST"> 
    <a class="btn btn-success"  title="Download Document"  data-toggle="modal" data-target="#editclaimstageTypeModal{{$ClaimNoticeStages->id}}" data-backdrop="static" data-keyboard="false"  style="
    margin-left: 25px;">Show</a>
  </form>
  @endif
  @endif
  <br/>
...
<div class="modal-footer" style="margin-bottom: 50px;">
  <div class="mx-auto" style="display: inline-flex;">
   <a class="btn btn-danger btn-space" href="{{ route('claimantrespondantaccess.index') }}"> Back</a>
 </div> 
</div> 
@else
<div class="modal-footer" style="margin-bottom: 50px;">
